...
func animate():
	...
	tween.tween_property(btn_start, 'position:x', 0.0, 0.4).from(2000)
	tween.parallel().tween_property(btn_options, 'position:x', 0.0, 0.6).from(2000)
	tween.parallel().tween_property(btn_about, 'position:x', 0.0, 0.8).from(2000)
